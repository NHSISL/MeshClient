...
namespace NEL.MESH.Tests.Unit.Services.Foundations.Chunks
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSplitFileMessageIntoChunksIfMessageIsNullAsync()
        {
            // given
            ...
            Action splitMessageIntoChunksAction = () =>
                this.chunkService.SplitFileMessageIntoChunks(message: nullMessage);
