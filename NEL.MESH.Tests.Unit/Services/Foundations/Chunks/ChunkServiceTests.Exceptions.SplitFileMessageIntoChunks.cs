...
namespace NEL.MESH.Tests.Unit.Services.Foundations.Chunks
{
    ...
    {
        [Fact]
        public async Task ShouldThrowServiceExceptionIfServiceErrorOccursOnSplitFileMessageIntoChunks()
        {
            // given
            ...
            Action splitMessageIntoChunksAction = () =>
                this.chunkService.SplitFileMessageIntoChunks(message: someMessage);
