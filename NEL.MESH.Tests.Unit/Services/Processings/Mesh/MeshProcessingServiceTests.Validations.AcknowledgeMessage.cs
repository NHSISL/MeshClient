...
namespace NEL.MESH.Tests.Unit.Services.Processings.Mesh
{
    public partial class MeshProcessingServiceTests
    {
        ...
        [InlineData("")]
        [InlineData(" ")]
        public async Task ShouldThrowValidationExceptionOnAcknowledgeMessageIfTokenIsNullOrEmptyAsync(string invalidText)
        {
            // given
            ...
            ValueTask<bool> getMessagesTask =
                this.meshProcessingService.AcknowledgeMessageAsync(invalidMessageId, invalidAuthorizationToken);
            ...
            this.meshServiceMock.Verify(service =>
                service.AcknowledgeMessageAsync(invalidMessageId, invalidAuthorizationToken),
                    Times.Never);
