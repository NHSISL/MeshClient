        ...
        public void GenerateBuildScript(string branchName, string projectName, string dotNetVersion)
        {
            var githubPipeline = new GithubPipeline
            {
                ...
                EnvironmentVariables = new Dictionary<string, string>
                {
                    ...
                    { "MESHCONFIGURATIONS__TLSINTERMEDIATECERTIFICATES1__0", "${{ secrets.MESHCONFIGURATIONS__TLSINTERMEDIATECERTIFICATES1__0 }}" },
                    { "MESHCONFIGURATIONS__TLSINTERMEDIATECERTIFICATES2__0", "${{ secrets.MESHCONFIGURATIONS__TLSINTERMEDIATECERTIFICATES2__0 }}" },
                    { "MESHCONFIGURATIONS__TLSROOTCERTIFICATES1__0", "${{ secrets.MESHCONFIGURATIONS__TLSROOTCERTIFICATES1__0 }}" },
                    { "MESHCONFIGURATIONS__TLSROOTCERTIFICATES2__0", "${{ secrets.MESHCONFIGURATIONS__TLSROOTCERTIFICATES2__0 }}" },
                },
